        ...
        <View style={{ alignItems: 'center', marginTop: 20 }}>
          ...
          >
            {isLoadingCredits ? (
              ...
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#ffffff' }}>{credits}</Text>
            )}
          </View>
        </View>
      </View>
          ...
          <>
            ...
            <View style={{ paddingHorizontal: 20 }}>
              ...
              >
                ...
                <Text style={{ fontSize: 16, color: '#64748b', marginBottom: 25, lineHeight: 24 }}>
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ alignItems: 'flex-end' }}>
                      ...
                      <Text style={{ fontSize: 14, color: '#64748b' }}>₹{transaction.amount}</Text>
                    </View>
                  </View>
