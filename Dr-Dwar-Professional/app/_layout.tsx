...
function InitialLayout() {
  ...
  const getPageDescription = (segments: string[]) => {
    ...
    const pageDescriptions: { [key: string]: string } = {
      ...
      '(root)/user-credits':
        'User Credits page: View and manage your available credits for using Dr-Dwar-Professional services. Buy credits at just 1 INR per credit.',
      '(root)/(tabs)/profile':
      ...
      '(auth)/Sign-in':
        'Sign In page: Enter your credentials to securely access your Dr-Dwar-Professional account.',
      '(auth)/Sign-up':
        'Sign Up page: Create a new account to start using Dr-Dwar-Professional health services.',
      terms:
        'Terms of Service page: Read the terms and conditions for using the Dr-Dwar-Professional application.',
      credits:
        'Credits page: Know the technology stack and meet the contributors who developed the Dr-Dwar-Professional app.',
