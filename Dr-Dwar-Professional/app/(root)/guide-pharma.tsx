...
export default function GuidePharmaScreen() {
  const { user } = useUser();
  ...
  const steps = [
    {
      ...
      description: 'Fill in your pharmacy details, license information, and contact details.',
      icon: 'account-check',
    },
    {
      title: 'Upload Pharmacy License',
      description: 'Submit a clear photo of your pharmacy license and registration certificate.',
      icon: 'file-document',
    },
    {
      title: 'Provide Pharmacy Information',
      description: 'Add details about your pharmacy location, operating hours, and services.',
      icon: 'pharmacy',
    },
    {
      title: 'Inventory Setup',
      description: 'Configure your medicine inventory and pricing for online orders.',
    ...
    <ScrollView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      ...
      <View style={{ padding: 20, paddingTop: 40, backgroundColor: '#F8FAFC' }}>
        ...
        <View style={{ alignItems: 'center', marginTop: 20 }}>
          <MaterialCommunityIcons name="medical-bag" size={48} color="#10B981" />
          <Text
          ...
          >
            Follow these steps to get verified and start serving customers
          </Text>
        </View>
      </View>
      ...
      <View style={{ padding: 20 }}>
        ...
        >
          ...
          >
            {isVerified
              ? 'Your pharmacy is verified. You can now access all features.'
