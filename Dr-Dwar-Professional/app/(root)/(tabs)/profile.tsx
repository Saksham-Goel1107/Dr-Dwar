...
export default function ProfileSettings() {
      ...
      if (val) {
        ...
        await Notifications.scheduleNotificationAsync({
          content: {
            ...
            body: 'Welcome to Dr-Dwar-Professional! You will now receive important health updates and reminders.',
            sound: 'default',
          },
  ...
  const handleAbout = () => {
    Alert.alert(
      'About Dr-Dwar-Professional',
      'Dr-Dwar-Professional is your AI-powered health assistant.\n\nVersion: 1.0.0\nMADE WITH ❤️ IN INDIA By Saksham Goel\n© 2025 Dr-Dwar-Professional Team',
      [{ text: 'OK' }],
    );
  };
        ...
        <View className="mb-6 rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
          <View className="items-center">
            ...
            <View className="mt-2 flex-row items-center space-x-2">
              {user?.unsafeMetadata.isVerified ? (
                <>
                  <Ionicons name="shield-checkmark" size={16} color="#3B82F6" />
                  <Text className="text-xs font-medium text-blue-600">Verified Account</Text>
                </>
              ) : (
                <Text className="text-xs font-medium text-blue-600">Unverified Account</Text>
              )}
            </View>
          </View>
        </View>
