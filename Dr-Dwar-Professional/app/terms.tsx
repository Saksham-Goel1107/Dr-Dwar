    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f7fafc' }}>
      ...
      >
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            Welcome to Dr-Dwar-Professional (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;).
            These Terms of Service (&quot;Terms&quot;) govern your use of our mobile application and
            services. By accessing or using Dr-Dwar-Professional, you agree to be bound by these
            Terms.
          </Text>
          <Text
            style={{
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            Dr-Dwar-Professional is a healthcare platform designed to connect rural communities with
            quality healthcare services. Our services include:
          </Text>
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            As a user of Dr-Dwar-Professional, you agree to:
          </Text>
          <View style={{ marginLeft: 16, marginBottom: 16 }}>
            <Text
              style={{
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            Dr-Dwar-Professional is not a substitute for professional medical advice, diagnosis, or
            treatment. Always seek the advice of qualified healthcare providers for any medical
            condition.
          </Text>
          <Text
            style={{
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            Some services on Dr-Dwar-Professional may require payment. By using paid services, you
            agree to:
          </Text>
          <View style={{ marginLeft: 16, marginBottom: 16 }}>
            <Text
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            To the maximum extent permitted by applicable law, Dr-Dwar-Professional shall not be
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            Your continued use of Dr-Dwar-Professional after such modifications constitutes
        ...
        >
          ...
          >
            © 2025 Dr-Dwar-Professional. All rights reserved.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
